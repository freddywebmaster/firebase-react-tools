...
export interface IFirebaseFunctions<T> {
  ...
  addInArray(id: string, field: string, data: any): Promise<IResponseFirestore<{ error: boolean; message: string }>>;
  deleteInArray(id: string, field: string, data: any): Promise<IResponseFirestore<{ error: boolean; message: string }>>;
